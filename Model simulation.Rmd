...
library(readxl)
Model_data_1995 <- read_excel("Data/Model_data_1995.xlsx")
Model_data_1996 <- read_excel("Data/Model_data_1996.xlsx")
Trade_variables <- read_excel("Data/Trade variables.xlsx")
Model_data_collected_IO <- read_excel("Data/Model_data_collected_IO_117.xlsx")
Emission_coeff_data <- read_excel("Data/Emission_coeff_data.xlsx")
Model_data_RER_1995 <- read_excel("Data/Model_data_RER_1995.xlsx")
Model_data_RER_1996 <- read_excel("Data/Model_data_RER_1996.xlsx")
Model_baci_data <- read_excel("Data/Model_baci_data.xlsx")
Model_data_leak <- read_excel("Data/Model_data_leak.xlsx")
Model_data_cons <- read_excel("Data/Model_data_cons.xlsx")
Model_data_industry_sector_shares <- read_excel("Data/Model_data_industry_sector_shares.xlsx")
...
We create variables used for making the shocks in the model code.
...
######## Shock 4 combination of consumption subsidies and consumption tax
S_modelData$Scenario_4= TIMESERIES(rep(0,36), START = c(1995,1), FREQ = 1)

######## Shock 5 combination of consumption and production tax
...
```{r}
S_modelData$time= TIMESERIES(0:length(S_modelData$ck_tot), START = c(1995,1), FREQ = 1)
```
...
## Adjusting small inconsistencies in income
...
# Creating ratios for behavioural equations
...
We define new variables used to implement the consumption tax
...
We need to define the general wage target, and the general productivity.
...
plot(Exo_model$simulation$pconk, col= "red", ylab= "B. DKR" , main= "Domestic consumption", ylim=c(650,1500), lwd=3, xlab="", cex.main=1.8); lines(S_modelData$pcon_2010_pout, col = "blue", lwd=3, xlab=""); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()
...
plot(Exo_model$simulation$ik, col= "red", ylab= "B. DKR" , main= "Real Investments", ylim=c(250,600) , lwd=3, xlab="", cex.main=1.8); lines(S_modelData$inv_2010_pout, col = "blue", lwd=3, xlab=""); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()


plot(Exo_model$simulation$xk, col= "red", ylab= "B. DKR" , main= "Real export", ylim=c(500,1300) , lwd=3, xlab="", cex.main=1.8); lines(S_modelData$ex_2010_pout, col = "blue", lwd=3, xlab=""); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()
...
NOTE: the simulation will say no convergence as the shock is introduced. This is because of the equation activating the shock variable "Scenario_1" running in a loop (which doesnt affect any other equation).
...
# Scenario 4 Policy mix Consumption tax and subsidies
...
Delta_GHG_tot_cusum_row_S1=TIMESERIES(c(Delta_GHG_tot_cusum_row_S1), START = c(2000,1),FREQ=1)
Delta_GHG_tot_cusum_row_S2=TIMESERIES(c(Delta_GHG_tot_cusum_row_S2), START = c(2000,1),FREQ=1)
Delta_GHG_tot_cusum_row_S4=TIMESERIES(c(Delta_GHG_tot_cusum_row_S4), START = c(2000,1),FREQ=1)
Delta_GHG_tot_cusum_row_S5=TIMESERIES(c(Delta_GHG_tot_cusum_row_S5), START = c(2000,1),FREQ=1)

Delta_GHG_tot_cusum_DK_S1=TIMESERIES(c(Delta_GHG_tot_cusum_DK_S1), START = c(2000,1),FREQ=1)
Delta_GHG_tot_cusum_DK_S2=TIMESERIES(c(Delta_GHG_tot_cusum_DK_S2), START = c(2000,1),FREQ=1)
Delta_GHG_tot_cusum_DK_S4=TIMESERIES(c(Delta_GHG_tot_cusum_DK_S4), START = c(2000,1),FREQ=1)
Delta_GHG_tot_cusum_DK_S5=TIMESERIES(c(Delta_GHG_tot_cusum_DK_S5), START = c(2000,1),FREQ=1)

Delta_GHG_tot_cusum_world_S1=TIMESERIES(c(Delta_GHG_tot_cusum_row_S1+Delta_GHG_tot_cusum_DK_S1), START = c(2000,1),FREQ=1)
Delta_GHG_tot_cusum_world_S2=TIMESERIES(c(Delta_GHG_tot_cusum_row_S2+Delta_GHG_tot_cusum_DK_S2), START = c(2000,1),FREQ=1)
Delta_GHG_tot_cusum_world_S4=TIMESERIES(c(Delta_GHG_tot_cusum_row_S4+Delta_GHG_tot_cusum_DK_S4), START = c(2000,1),FREQ=1)
Delta_GHG_tot_cusum_world_S5=TIMESERIES(c(Delta_GHG_tot_cusum_row_S5+Delta_GHG_tot_cusum_DK_S5), START = c(2000,1),FREQ=1)

Leak_rate_tot_S1=TIMESERIES(c(-Delta_GHG_tot_cusum_row_S1/Delta_GHG_tot_cusum_DK_S1), START = c(2000,1),FREQ=1)
Leak_rate_tot_S2=TIMESERIES(c(-Delta_GHG_tot_cusum_row_S2/Delta_GHG_tot_cusum_DK_S2), START = c(2000,1),FREQ=1)
Leak_rate_tot_S4=TIMESERIES(c(-Delta_GHG_tot_cusum_row_S4/Delta_GHG_tot_cusum_DK_S4), START = c(2000,1),FREQ=1)
Leak_rate_tot_S5=TIMESERIES(c(-Delta_GHG_tot_cusum_row_S5/Delta_GHG_tot_cusum_DK_S5), START = c(2000,1),FREQ=1)
```
...
Delta_GDP_tot_cusum_DK_S1=TIMESERIES(c(Delta_GDP_tot_cusum_DK_S1), START = c(2000,1),FREQ=1)
Delta_GDP_tot_cusum_DK_S2=TIMESERIES(c(Delta_GDP_tot_cusum_DK_S2), START = c(2000,1),FREQ=1)
Delta_GDP_tot_cusum_DK_S4=TIMESERIES(c(Delta_GDP_tot_cusum_DK_S4), START = c(2000,1),FREQ=1)
Delta_GDP_tot_cusum_DK_S5=TIMESERIES(c(Delta_GDP_tot_cusum_DK_S5), START = c(2000,1),FREQ=1)
